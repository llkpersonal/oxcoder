    ...
    */
    ...
    _placeEachUnit : function(masn,c,$d,$data,htmlp,indom,resize,f){
      ...
      $htmlp = $drawer.find(c.unit).not('.woo-f,.woo-wait').each(function (i,e){
        ...
        strwrap += '<div class="col-xs-12 col-lg-3 col-md-4 '+c.unit.substr(1)+' co'+minI+(colwf?' woo-spcol':'')+'" '+ (id?'data-id="'+id+'"':'')+' data-ht="'+ht+'" data-idx="'+masn.unitCount+'" style="top:'+minY+'px;left:'+left+'px;"></div>';
