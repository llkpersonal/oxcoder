$(document).ready(function(){
	...
	$("#select-salary").change(function(){
		...
		location.replace("index.action?flag="+$("#input-flag").val()+"&salary="+$("#select-salary").val()+"&province="+$("#province").val()+"&retype="+$("#input-retype").val());
	...
	$("#select-retype").change(function(){
		...
		location.replace("index.action?flag="+$("#input-flag").val()+"&salary="+$("#select-salary").val()+"&province="+$("#province").val()+"&retype="+$("#select-retype").val());
