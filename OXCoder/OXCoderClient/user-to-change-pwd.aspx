<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user-to-change-pwd.aspx.cs" Inherits="OXCoderClient.user_to_change_pwd" %>
...
<body style="">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
                <div id="content">
                    <div class="row">
                        <form id="defaultForm" action="./user-to-change-pwd-handler.aspx" class="form-horizontal bv-form" enctype="multipart/form-data" method="post" novalidate="novalidate">
    ...
    <script src="./user-to-change-pwd_files/bootstrap.min.js"></script>

    <!-- Sparkline -->
    <script src="./user-to-change-pwd_files/jquery.sparkline.min.js"></script>

    <!-- Bootstrap Switch -->
    <script src="./user-to-change-pwd_files/bootstrap-switch.min.js"></script>

    <!-- Bootstrap Select -->
    <script src="./user-to-change-pwd_files/bootstrap-select.min.js"></script>

    <!-- Bootstrap File -->
    <script src="./user-to-change-pwd_files/bootstrap-filestyle.js"></script>



    <!-- Summernote -->
    <script src="./user-to-change-pwd_files/summernote.min.js"></script>

    <!-- Theme script -->
    <script src="./user-to-change-pwd_files/script.js"></script>
    <!-- 引入footer -->
    ...
    <script src="./user-to-change-pwd_files/bootstrapValidator.js"></script>
    <script type="text/javascript">
