...
<link href="./user-resume_files/style.css" rel="stylesheet" type="text/css">

<!-- Max css -->
<link href="./user-resume_files/style_new.css" rel="stylesheet" type="text/css">
				...
				<section id="Section1">
					...
					<div class="panel-body shadow-effect" style="margin-top: 20px;">
						...
						<div class="col-md-4 center">
								...
								<div class="img-hide">
									<a target="_blank" href="https://api.weibo.com/oauth2/authorize?client_id=3064453059&response_type=code&forcelogin=true&redirect_uri=./auth-sina.action">绑定</a>
...
<!-- 										target="_blank">绑定</a> -->
										 <a href="https://github.com/login/oauth/authorize?client_id=cb26d4b4731db53e8a90&redirect_uri=./auth-github.action" target="_blank">绑定</a>
								</div>
...
<!-- 						</div> -->
						<div class="col-md-4 center">
							...
							<img src="./user-resume_files/zhihu2.png">
							<!-- 								</a> -->
							<!-- 							<div class="img-hide"> -->
							<!-- 								<a href="">绑定</a> -->
							<p class="text-muted text-center">暂未开放</p>
						...
						<div class="col-md-4 center">
							...
							<img src="./user-resume_files/quora2.png">
							<!-- </a> -->
							<!-- <div class="img-hide">
								<a href="#">绑定</a>
							</div> -->
						...
						<div class="col-md-4 center">
							...
							<img src="./user-resume_files/stackoverflow2.png">
							<!-- </a> -->
							<!-- <div class="img-hide">
								<a href="#">绑定</a>
							</div> -->
						...
						<div class="col-md-4 center">
							...
							<img src="./user-resume_files/sf2.png">
							<!-- </a> -->
							<!-- <div class="img-hide">
								<a href="#">绑定</a>
							</div> -->
						...
						<div class="col-md-4 center">
							...
							<img src="./user-resume_files/csdn2.png">
							<!-- </a> -->
							<!-- <div class="img-hide">
								<a href="#">绑定</a>
							</div> -->
	...
	<form>
		<input id="input-speed-all" type="hidden" value="9.58"> <input id="input-manito-all" type="hidden" value="3.67"> <input id="input-error-all" type="hidden" value="5.27"> <input id="input-time-all" type="hidden" value="1.92"> <input id="input-speed" type="hidden" value="0.0"> <input id="input-manito" type="hidden" value="0.0"> <input id="input-error" type="hidden" value="0.0"> <input id="input-time" type="hidden" value="0.0">
	</form>

	<!-- jQuery -->
	<script src="./user-resume_files/jquery-1.11.0.min.js"></script>

	<!-- Bootstrap core JavaScript -->
	<script src="./user-resume_files/bootstrap.min.js"></script>

	<!-- Sparkline -->
	<script src="./user-resume_files/jquery.sparkline.min.js"></script>

	<!-- Bootstrap Switch -->
	<script src="./user-resume_files/bootstrap-switch.min.js"></script>

	<!-- Bootstrap Select -->
	

	<!-- Bootstrap File -->
	<script src="./user-resume_files/bootstrap-filestyle.js"></script>
	<!-- Summernote -->
	<script src="./user-resume_files/summernote.min.js"></script>

	<!-- Chart.js  -->
	<script src="./user-resume_files/Chart.js"></script>
