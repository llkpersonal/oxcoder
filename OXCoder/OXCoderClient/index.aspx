...
<link href="http://www.oxcoder.com/css/styler/style_new.css" rel="stylesheet">
...
<body style="">
	...
	<div class="jumbotron">
		<img src="./index_files/Bitmap3.png" style="max-width: 350px;">
	...
	<div class="container">
		...
		<div class="row featurette">
			...
			<div class="col-md-5">
				<img class="featurette-image img-responsive shadow-effect" data-src="holder.js/500x500/auto" alt="500x500" src="./index_files/website7.png">
			</div>
		</div>
		...
		<div class="row featurette">
			...
			<div class="col-md-5" style="float: left;">
				<img class="featurette-image img-responsive shadow-effect" data-src="holder.js/500x500/auto" alt="500x500" src="./index_files/website6.png">
			</div>
		</div>
		...
		<div class="row featurette">
			...
			<div class="col-md-12">
				<img class="featurette-image img-responsive" src="./index_files/languages.png" style="margin: auto; margin-bottom: 60px;">
			</div>
	...
	<!-- Sparkline -->
	<script src="./index_files/jquery.sparkline.min.js"></script>

	<!-- Bootstrap Switch -->
	<script src="./index_files/bootstrap-switch.min.js"></script>

	<!-- Bootstrap Select -->
	<script src="./index_files/bootstrap-select.min.js"></script>

	<!-- Bootstrap File -->
	<script src="./index_files/bootstrap-filestyle.js"></script>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					</script><span id="cnzz_stat_icon_1253509620"><a href="http://www.cnzz.com/stat/website.php?web_id=1253509620" target="_blank" title="站长统计"><img border="0" hspace="0" vspace="0" src="./index_files/pic.gif"></a></span><script src="./index_files/z_stat.php" type="text/javascript"></script><script src="./index_files/core.php" charset="utf-8" type="text/javascript"></script>
				</div>
			</div>
