<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup2-sub.aspx.cs" Inherits="OXCoderClient.signup2_sub" %>

<!DOCTYPE html>
<!-- saved from url=(0041)http://www.oxcoder.com/signup2-sub.action -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="Font-Awesome-3.2.1\css\font-awesome.min.css" rel="stylesheet">
        ...
        <link href="./signup2-sub_files/style.css" rel="stylesheet" type="text/css">

        <!-- Max css -->
        <link href="./signup2-sub_files/style_new.css" rel="stylesheet" type="text/css">
...
<div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="http://www.oxcoder.com/index.htm" style="padding: 0;"><img src="./signup2-sub_files/wlogo_sm.png" style="max-height: 35px;margin:7px;"></a>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-md-push-3 col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
                    <div id="content">
                        <div class="row">
                        <font color="red"></font>
                            <form id="defaultForm" method="post" class="form-vertical bv-form" action="./signup2-sub-handle.aspx" enctype="multipart/form-data" novalidate="novalidate"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
                                <input id="input-provincework" type="hidden" value="">
                                <input id="input-citywork" type="hidden" value="">
                                <img src="./signup2-sub_files/corp_step1.png">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="help-block has-error" id="hint2"><small class="help-block" data-bv-validator="notEmpty" data-bv-for="image" data-bv-result="NOT_VALIDATED" style="display: none;">请上传公司logo</small></span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="warp">
                                        ...
                                        <option name="1101" value="东城区">东城区</option><option name="1102" value="西城区">西城区</option><option name="1108" value="海淀区">海淀区</option><option name="1105" value="朝阳区">朝阳区</option><option name="1106" value="丰台区">丰台区</option><option name="1107" value="石景山区">石景山区</option><option name="1109" value="门头沟区">门头沟区</option><option name="1111" value="房山区">房山区</option><option name="1112" value="通州区">通州区</option><option name="1113" value="顺义区">顺义区</option><option name="1114" value="昌平区">昌平区</option><option name="1115" value="大兴区">大兴区</option><option name="1116" value="怀柔区">怀柔区</option><option name="1117" value="平谷区">平谷区</option><option name="1128" value="密云县">密云县</option><option name="1129" value="延庆县">延庆县</option></select>
                                    </div>
        ...
        <!-- jQuery -->
        <script src="./signup2-sub_files/jquery-1.11.0.min.js"></script>

        <!-- Bootstrap core JavaScript -->
        <script src="./signup2-sub_files/bootstrap.min.js"></script>

        <!-- Sparkline -->
        <script src="./signup2-sub_files/jquery.sparkline.min.js"></script>

        <!-- Bootstrap Switch -->
        <script src="./signup2-sub_files/bootstrap-switch.min.js"></script>

        <!-- Bootstrap Select -->
        <script src="./signup2-sub_files/bootstrap-select.min.js"></script>

        <!-- Bootstrap File -->
        <script src="./signup2-sub_files/bootstrap-filestyle.js"></script>

        

        <!-- Summernote -->
        <script src="./signup2-sub_files/summernote.min.js"></script>

        <!-- Theme script -->
        <script src="./signup2-sub_files/script.js"></script>

        <script type="text/javascript" src="./signup2-sub_files/jquery.city.select.js"></script>

        <script src="./signup2-sub_files/bootstrapValidator.js"></script>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if ($("#input-provincework").val() != "" && $("#input-citywork").val() != "") {
